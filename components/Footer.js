  ...
  return (
    <div>
      <div className="flex flex-col-reverse md:flex-row justify-between">
        <div className="md:flex justify-between md:w-1/2 my-5 md:my-0">
          <div className="mb-4 md:mb-0">
            ...
            <ul
              className={companyMenu ? "block ml-3 md:ml-0" : "hidden md:block"}
            >
              <li>About Us</li>
              <li>Award</li>
              <li>Contact Us</li>
        ...
        <div className="flex flex-col-reverse md:flex-row justify-between md:w-1/2 my-5 md:ml-96 md:my-0">
          <div>
      ...
      <div className="flex flex-wrap">
        <p className="text-sm text-slate-500 md:text-xl mr-5">
          Risk disclosure
        </p>
        <p className="text-sm text-slate-500 md:text-xl mr-5">Privacy policy</p>
        <p className="text-sm text-slate-500 md:text-xl mr-5">Return policy</p>
        <p className="text-sm text-slate-500 md:text-xl mr-5">
          Customer Agreement
        </p>
        <p className="text-sm text-slate-500 md:text-xl">AML policy</p>
      </div>
      <p className="text-sm my-3">
        © 2023 Octa Markets Incorporated, registration number: 19776 IBC 2011.
        Contact e-mail: support@octafx.com.
      </p>
    </div>
  );
}
