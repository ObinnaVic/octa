export const Data = [
  {
    ...
    infos: {
      itemOne: {
        head: "YOUR FINANCES",
        one: "Deposits & Withdrawals",
        two: "Payment options",
        three: "Negative balance protection",
        four: "Funds security",
      },
      itemTwo: {
        head: "Trading Conditions",
        one: "Account Types",
        two: "Islamic account",
        three: "Demo account",
        four: "Spreads & conditions",
        five: "Trading advantages",
        six: "Why choose us",
      },
      itemThree: {
        head: "Assets",
  ...
  },
  {
    ...
    infos: {
      itemOne: {
        ...
        one: "Why our referral program",
        two: "Why clients choose us",
        three: "IB Checklist",
      },
      itemTwo: {
        head: "IB PROGRAM",
        ...
        one: "Invite a friend",
        two: "IB program",
        three: "Master IB program",
      },
      itemThree: {
        head: "IB PROMOTIONS",

        one: "IB monthly rewards",
      },
      itemFour: {
  ...
  {
    menu: "ANALYSIS & EDUCATION",
    id: 5,
    infos: {
      itemOne: {
        head: "TRADERS TOOLS",

        one: "Trading Calculator",
        two: "Profit Calculator",
        three: "Live Quotes",
        four: "Monitoring",
        five: "Antichartist",
      },
      itemTwo: {
        ...
        one: "Market Information",
        two: "Economic Calender",
  ...
  },
  {
    ...
    infos: {
      itemOne: {
        ...
        one: "Join Copy Trading",
        two: "Copier Area",
        three: "Master trder's rating",
      },
      itemTwo: {
        head: "FOR MASTER TRADERS",

        one: "Become A Master Trader",
        two: "Master Area",
      },
      itemThree: {
        head: "INFORMATION",
...
export const dataThree = [
  ...
  },
  {
    ...
    date: "3 November",
    Head: "Awesome Broker",
    message: "Awesome broker, Easy to use",
  },
  {
    rating: 5,
    name: "Ella Paul",
    date: "2 November",
    Head: "Still the number one ECN Broker",
    message: "Still the number one ECN broker, fast deposit",
  },
  {
    rating: 5,
    name: "Mitchel Sosa",
    date: "27 October",
    Head: "OctaFX is awesome",
    message: "OctaFX is awesome plaform, no issues with depositing",
  },
  {
    rating: 3,
    name: "Oyetunji Maruf",
    date: "24 October",
    Head: "OctaFx customer service",
    message: "OctaFx customer service is the best",
  },
  {
    rating: 4,
    name: "Eyad Awad",
    date: "19 October",
    Head: "Perfect Services",
    message: "High speed for deposit and withdrawal",
  },
  {
    rating: 5,
    name: "Ismail Meera",
    date: "6 October",
    Head: "Very Good Platform",
    message: "Good experience in this platform so far.",
  },
  {
    rating: 5,
    name: "Urmira Aide",
    date: "21 October",
    Head: "Resolving Problems",
    message: "Trading and resoving problems daily",
  },
  {
    rating: 4,
    name: "Manasi Biswal",
    date: "4 October",
    Head: "One of the best broker",
    message: "One of the best broker of my experiences",
  },
  {
    rating: 5,
    name: "Vincent Obiero",
    date: "10 November",
    Head: "You are simply the best",
    message: "This broker is simply the best broker",
  },
  {
    rating: 5,
    name: "Lee Kai Kang",
    date: "16 November",
    Head: "Transparent",
    message: "Transparent, simple and easy to use",
  },
  {
    rating: 5,
    name: "De Leur",
    date: "3 October",
    Head: "Early user",
    message: "Started today with this broker and it is a great experience",
  },
  {
    rating: 3,
    name: "Ahsan Kazmi",
    date: "28 September",
    Head: "Very secure and recommended",
    message: "Very secure and recommended platform for day traders",
  },
  {
    rating: 5,
    name: "Ibrahim Mustapha",
    date: "28 September",
    Head: "Best in Nigeria",
    message: "OctaFx is the best I can find in Nigeria",
  },
];